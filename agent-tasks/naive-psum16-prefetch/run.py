#!/usr/bin/env python3
"""Run sequential PSUM16 blackboxes through the established wrapper runner."""
...
BUILD = ROOT / 'build_naive_input_contexts_verify'
...
def main():
    ...
    for m in (4, 256):
        ...
        result = dict(m=m, k=512, n=512, runner_returncode=run.returncode,
