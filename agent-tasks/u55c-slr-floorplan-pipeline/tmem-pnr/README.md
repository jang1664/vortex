...
| --- | --- |
| URAM | `build/pnr/build_timing_cuts_pnr_th32_tcol32_m32_bigmem_hbm4_tmem8_uram_spread_v1` |
| BRAM | `build/pnr/build_timing_cuts_pnr_th32_tcol32_m32_bigmem_hbm4_tmem8_bram_spread_v1` |
...
`build/pnr/build_timing_cuts_pnr_artifacts/th32_tcol32_m32_bigmem_hbm4_tmem8_<uram|bram>_spread_v1/`
...
`build/pnr/build_timing_cuts_pnr_artifacts/tmem_spread_v1_monitor/history.jsonl`.
