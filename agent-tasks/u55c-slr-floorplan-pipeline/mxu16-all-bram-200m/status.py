#!/usr/bin/env python3
"""Hourly status snapshot for the 200 MHz MXU16 all-BRAM experiment."""
...
ROOT = TASK.parents[2]
TAG = "th16_tcol16_m16_t8_bigmem_all_bram_200m_spread_v1"
spec = importlib.util.spec_from_file_location("pnr_status", TASK.parent / "timing-cuts-pnr/status.py")
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)

if __name__ == "__main__":
    run = module.snapshot(ROOT, TAG, "MXU16/HBM4/DMA4/TMEM8/all-BRAM/200MHz")
    ...
    evidence = ROOT / "build_timing_cuts_pnr_artifacts/mxu16_all_bram_200m_monitor"
