...
- `build_tmem_exploration_verify_uram`
- `build_tmem_exploration_verify_bram`
- `build_tmem_exploration_verify_default` (default-selection regression only)

`build_tmem_placement_exploration` was also configured for build-option integration
...
```bash
cd /home/jaeyongjang/project.local/vortex_fpint/build_tmem_exploration_verify_uram/hw/syn/xilinx/xrt
...
```bash
cd /home/jaeyongjang/project.local/vortex_fpint/build_tmem_exploration_verify_bram/hw/syn/xilinx/xrt
FAST_MODE=0 ./run_hw.sh \
...
Historical VCS reports remain in `build_tmem_exploration_verify_a2/verification.json`
(URAM), `build_tmem_exploration_verify_b2/verification.json` (BRAM), and the default
...
Their logs are under `build_tmem_placement_exploration/` (`ini_tests.log` and
