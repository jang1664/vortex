#!/usr/bin/env python3
"""Read-only status snapshots for the all-BRAM source PnR experiment."""
...
ROOT = TASK.parents[2]
TAG = "th32_tcol32_m32_bigmem_hbm4_tmem8_all_bram_spread_v1"
...
if __name__ == "__main__":
    run = module.snapshot(ROOT, TAG, "TH32/HBM4/TMEM8/all-BRAM")
    ...
    evidence = ROOT / "build_timing_cuts_pnr_artifacts/all_bram_spread_v1_monitor"
