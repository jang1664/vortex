#!/usr/bin/env python3
"""Measure improve N-fast micro-tile traversal at M4 and M256 with FSDB."""
import argparse
...
parser.parse_args()
BUILD = ROOT / 'build_improve_nfast_vcs'
...
def main():
    ...
    for m in (4, 256):
        ...
        result = dict(backend='improve', micro_tile_order='N-fast', m=m, k=512, n=512, runner_returncode=run.returncode,
        ...
        (TASK / 'runs' / 'results.json').write_text(json.dumps(results, indent=2) + '\n')
