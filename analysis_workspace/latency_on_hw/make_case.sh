...
if [[ "$target" == "full" ]]; then
  ./make_cases.sh \
    ...
    --output generated_suites/llama2_7b_main_full.${experiment_tag} \
    --prefill-batches 1 \
    --prefill-seq-lens 1024,2048,4096,8192,16384,32768 \
    --generation-batches 1,4,64 \
  ...
  ./make_cases.sh \
    ...
    --output generated_suites/llama3_8b_main_full.${experiment_tag} \
    --prefill-batches 1 \
    --prefill-seq-lens 1024,2048,4096,8192,16384,32768 \
    --generation-batches 1,4,64 \
    --generation-seq-lens 1024,2048,4096,8192,16384,32768 \
  ...
  ./make_cases.sh \
    --input suites/llama2_7b \
    --output generated_suites/llama2_7b_main_quick.${experiment_tag} \
    --prefill-batches 1 \
  ...
  ./make_cases.sh \
    --input suites/llama3_8b \
    --output generated_suites/llama3_8b_main_quick.${experiment_tag} \
    --prefill-batches 1 \
    --prefill-seq-lens 1024 \
    --generation-batches 1 \
    --generation-seq-lens 1024 \
