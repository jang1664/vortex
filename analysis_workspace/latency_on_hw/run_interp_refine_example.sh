...
# Reference command: refine Llama2 C4 decode interpolation one kernel type at
# a time until p95 relative error reaches 3% or ten iterations are exhausted.
# Every successfully measured validation case is promoted into the main raw DB.
