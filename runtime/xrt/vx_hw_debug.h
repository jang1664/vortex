...
enum vx_hw_debug_metric {
  ...
  VX_HWDBG_AXI_WR_DRAIN_STATUS = 0x22,
  VX_HWDBG_AXI_WR_TXN_COUNTS   = 0x23,
  VX_HWDBG_AXI_WR_BEAT_COUNTS  = 0x24,
  VX_HWDBG_AXI_WR_LAST_COUNTS  = 0x25,
  VX_HWDBG_CTRL_STATUS     = 0x30,
	  ...
	  VX_HWDBG_CORE_STATUS      = 0x40,
	  VX_HWDBG_CORE_CHANNEL     = 0x41,
	  VX_HWDBG_CORE_FLAGS       = 0x42,
	  VX_HWDBG_CORE_FIRST_STUCK = 0x43,
	  VX_HWDBG_CORE_PROGRESS    = 0x44,
	  VX_HWDBG_CACHE_STATUS      = 0x50,
	  VX_HWDBG_CACHE_SOURCE      = 0x51,
	  VX_HWDBG_CACHE_PORT_LIVE   = 0x52,
	  VX_HWDBG_CACHE_REQ_COUNTS  = 0x53,
	  VX_HWDBG_CACHE_RSP_COUNTS  = 0x54,
	  VX_HWDBG_CACHE_LAST_REQ    = 0x55,
	  VX_HWDBG_CACHE_LAST_RSP    = 0x56,
...
enum vx_hw_debug_global_flag {
  ...
  VX_HWDBG_GLBL_PENDING_OVERFLOW  = 3,
	  ...
	  VX_HWDBG_GLBL_CORE_STALL        = 8,
	  VX_HWDBG_GLBL_CACHE_STALL       = 9,
		};
