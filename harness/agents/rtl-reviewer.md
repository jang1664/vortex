...
| GEMM architecture | `hw/rtl/core/gemm/VX_gemm_node.sv`, `VX_gemm_ctrl.sv`, `VX_gemm_fsm.sv` |
| Address space / MMIO | `hw/rtl/core/VX_job_frontend.sv`, `tests/regression/fpint_gemm_ffn_hw/common.h` |
| SW-HW interface | `tests/regression/fpint_gemm_ffn_hw/`, `kernel/src/fi_gemm.c` |
| Branch-specific opcodes, tiling, pipeline | `harness/rules/rtl-arch.md`, `harness/rules/kernel-arch.md` |
