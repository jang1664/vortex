...
- Unittests must be run from the build directory (e.g., `cd build && make -C hw/unittest/<test_name>`), where `hw/config.mk` is auto-generated by `../configure`. Do NOT create `hw/config.mk` in the source tree.
