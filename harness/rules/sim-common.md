...
- Before modifying simulator or XRT runtime code, inspect the current implementation in `runtime/xrt/vortex_v*.cpp`, `sim/xrtsim/`, `sim/xrtsim_vcs/`, and `hw/rtl/afu/xrt/`. This branch does not carry a dedicated HBM interleaving design note.
