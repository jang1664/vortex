...
int main(int argc, char *argv[]) {
  ...
  // co-resident on a core.
    ...
    SOFTMAX_LAYOUT_FUSED_VARIANT == SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_CHUNKED || \
...
#elif SOFTMAX_LAYOUT_FUSED_VARIANT == SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_CHUNKED
  printf("variant=rev2_chunked launch=one_warp_per_row\n");
#elif SOFTMAX_LAYOUT_FUSED_VARIANT == SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE
  printf("variant=rev2_shuffle launch=one_warp_per_row\n");
#elif SOFTMAX_LAYOUT_FUSED_VARIANT == SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE_UNROLL2
  printf("variant=rev2_shuffle_unroll2 launch=one_warp_per_row\n");
#elif SOFTMAX_LAYOUT_FUSED_VARIANT == SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE_ADDR32
