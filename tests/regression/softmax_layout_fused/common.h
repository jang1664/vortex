...
#define SOFTMAX_LAYOUT_FUSED_VARIANT_OPT_WARP 2
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2 3
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_ADDRGEN 4
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_CHUNKED 5
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE 6
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE_UNROLL2 7
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE_ADDR32 8
#define SOFTMAX_LAYOUT_FUSED_VARIANT_REV2_SHUFFLE_GROUPED 9
