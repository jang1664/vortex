...
int main(int argc, char *argv[]) {
  ...
  printf("SiLU (Swish) Test Configuration:\n");
  printf("  Size: %u elements, M=%u K=%u\n", size, M, K);
  ...
  // Grid/Block configuration - one logical work item per 32-element chunk.
