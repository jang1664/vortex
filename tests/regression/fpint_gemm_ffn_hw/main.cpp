...
static constexpr uint64_t DMA_MT = 128ull;
static constexpr uint64_t DMA_NT = 128ull;
static constexpr uint64_t DMA_KT = 128ull;

static constexpr uint32_t log2_pow2_u32_const(uint64_t x) {
  uint32_t s = 0;
  while ((1ull << s) != x) ++s;
  return s;
}
static constexpr uint32_t LOG2_DMA_MT = log2_pow2_u32_const(DMA_MT);
static constexpr uint32_t LOG2_DMA_KT = log2_pow2_u32_const(DMA_KT);
static constexpr uint32_t LOG2_DMA_NT = log2_pow2_u32_const(DMA_NT);
...
int main(int argc, char *argv[]) {
  ...
  kargs.LOG2_DMA_MT = LOG2_DMA_MT;
  kargs.LOG2_DMA_KT = LOG2_DMA_KT;
  kargs.LOG2_DMA_NT = LOG2_DMA_NT;
