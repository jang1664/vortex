...
// PERF: MXU fire/stall
`define VX_CSR_MPM_MXU_INPUT_FIRE      12'hB08
`define VX_CSR_MPM_MXU_INPUT_FIRE_H    12'hB88
...
`define VX_CSR_MPM_MXU_WEIGHT_FIRE     12'hB14
`define VX_CSR_MPM_MXU_WEIGHT_FIRE_H   12'hB94
`define VX_CSR_MPM_MXU_WEIGHT_STALL    12'hB15
`define VX_CSR_MPM_MXU_WEIGHT_STALL_H  12'hB95
`define VX_CSR_MPM_MXU_PSUM_FIRE       12'hB16
`define VX_CSR_MPM_MXU_PSUM_FIRE_H     12'hB96
`define VX_CSR_MPM_MXU_PSUM_STALL      12'hB17
`define VX_CSR_MPM_MXU_PSUM_STALL_H    12'hB97
`define VX_CSR_MPM_MXU_OUTPUT_FIRE     12'hB18
`define VX_CSR_MPM_MXU_OUTPUT_FIRE_H   12'hB98
// PERF: DMA fire/stall
`define VX_CSR_MPM_DMA_SRC_RD_REQ_FIRE   12'hB19
`define VX_CSR_MPM_DMA_SRC_RD_REQ_FIRE_H 12'hB99
`define VX_CSR_MPM_DMA_SRC_RD_REQ_STALL  12'hB1A
`define VX_CSR_MPM_DMA_SRC_RD_REQ_STALL_H 12'hB9A
`define VX_CSR_MPM_DMA_SRC_RD_DATA_FIRE  12'hB1B
`define VX_CSR_MPM_DMA_SRC_RD_DATA_FIRE_H 12'hB9B
`define VX_CSR_MPM_DMA_SRC_RD_DATA_STALL 12'hB1C
`define VX_CSR_MPM_DMA_SRC_RD_DATA_STALL_H 12'hB9C
`define VX_CSR_MPM_DMA_DST_WR_FIRE       12'hB1D
`define VX_CSR_MPM_DMA_DST_WR_FIRE_H     12'hB9D
`define VX_CSR_MPM_DMA_DST_WR_STALL      12'hB1E
`define VX_CSR_MPM_DMA_DST_WR_STALL_H    12'hB9E
