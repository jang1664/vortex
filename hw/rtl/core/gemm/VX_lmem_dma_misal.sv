...
`ifdef DBG_SCOPE_GEMM
  ...
  (* keep = "true", mark_debug = "true" *) wire [DBG_LMEM_DMA_P1_W-1:0] dbg_lmem_dma_probe1 = {
      out_off,
      seg_size_r,
      wr_nbytes,
      need_src,
  ...
  (* keep = "true", mark_debug = "true" *) wire [DBG_LMEM_DMA_P2_W-1:0] dbg_lmem_dma_probe2 = {
      base_src_seg,
      base_dst_seg,
      src_rd_ptr,
      src_rd_end,
  ...
  (* keep = "true", mark_debug = "true" *) wire [DBG_LMEM_DMA_P3_W-1:0] dbg_lmem_dma_probe3 = {
      stride_r[0][0],
      stride_r[1][0],
      stride_r[0][1],
      stride_r[1][1],
  ...
  ila_lmem_dma_misal ila_lmem_dma_misal_inst (
    .clk    (clk),
    .probe0 (dbg_lmem_dma_probe0),
    .probe1 (dbg_lmem_dma_probe1),
    .probe2 (dbg_lmem_dma_probe2),
    .probe3 (dbg_lmem_dma_probe3)
  );
`endif
`endif
