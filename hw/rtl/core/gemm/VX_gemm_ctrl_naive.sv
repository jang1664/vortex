...
module VX_gemm_ctrl_naive import VX_gpu_pkg::*; #(
...
`endif
    ...
    // Local interfaces
    // -------------------------------------------------------------------------
    VX_gemm_fsm_naive_if gemm_fsm_if        ();
    VX_gemm_fsm_naive_if gemm_pqueue_out    ();
    VX_gemm_fsm_naive_if gemm_sync_out[N_CHILDREN] ();
    VX_gemm_fsm_naive_if gemm_cqueue_out[N_CHILDREN] ();
    ...
    assign gemm_fsm_if.flag.idle = ~parent_q_full;
