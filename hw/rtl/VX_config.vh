...
`ifndef W_LMEM_DMA_RD_PREFETCH_DEPTH
`define W_LMEM_DMA_RD_PREFETCH_DEPTH `LMEM_DMA_RD_PREFETCH_DEPTH
`endif

`ifndef SZ_LMEM_DMA_RD_PREFETCH_DEPTH
`define SZ_LMEM_DMA_RD_PREFETCH_DEPTH `LMEM_DMA_RD_PREFETCH_DEPTH
`endif

`ifndef O_LMEM_DMA_RD_PREFETCH_DEPTH
`define O_LMEM_DMA_RD_PREFETCH_DEPTH `LMEM_DMA_RD_PREFETCH_DEPTH
`endif

`ifndef LMEM_DMA_RD_OUTSTANDING_SLOTS
`define LMEM_DMA_RD_OUTSTANDING_SLOTS 8
`endif
...
`ifndef O_LMEM_DMA_RD_OUTSTANDING_SLOTS
`define O_LMEM_DMA_RD_OUTSTANDING_SLOTS `LMEM_DMA_RD_OUTSTANDING_SLOTS
`endif

`ifndef DMA_RD_OUTSTANDING_SLOT
`define DMA_RD_OUTSTANDING_SLOT 8
`endif

`ifndef DMA_NODE_RD_OUTSTANDING_SLOT
`define DMA_NODE_RD_OUTSTANDING_SLOT `DMA_RD_OUTSTANDING_SLOT
`endif

`ifndef TMEM_DMA_RD_OUTSTANDING_SLOT
`define TMEM_DMA_RD_OUTSTANDING_SLOT `DMA_RD_OUTSTANDING_SLOT
`endif
