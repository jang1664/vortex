...
`endif
    ...
    localparam NUM_HBM_PORTS = `NUM_DMA_CHANNELS;
    localparam MEMORY_BANK_ADDR_WIDTH = `PLATFORM_MEMORY_ADDR_WIDTH - `CLOG2(NUM_HBM_PORTS);

    // device caps (num_banks = NUM_HBM_PORTS since top-level has that many AXI ports)
    wire [63:0] dev_caps = {8'b0,
                            5'(MEMORY_BANK_ADDR_WIDTH-20),
                            3'(`CLOG2(NUM_HBM_PORTS)),
