// FP16 multiplier vector for the per-output-column scaler stage. Same as
// VX_vec_fp16_mul, separate name so the hierarchy report distinguishes
// in-scaler power/area from out-scaler power/area at the top level.
`include "VX_define.vh"

module VX_vec_fp16_mul_outscale #(
