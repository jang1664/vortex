...
#   ss_0p900v_0p900v_125c       — slowest, 0.9V (LV), 125C
# For FF@min:
#   ff_1p100v_1p100v_m40c       — fastest, 1.1V (HV), -40C
#
...
set ss_corner "ss_0p900v_0p900v_125c"
set ff_corner "ff_1p100v_1p100v_m40c"
