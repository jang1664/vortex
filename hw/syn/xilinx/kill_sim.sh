...
ps -A | grep -E '(^|\s)simv(\s|$)' | awk '{print $1}' | xargs kill -9 $1
ps -A | grep -E '(^|\s)vcs(\s|$)' | awk '{print $1}' | xargs kill -9 $1
ps -A | grep vlogan | awk '{print $1}' | xargs kill -9 $1
ps -A | grep vcsd | awk '{print $1}' | xargs kill -9 $1