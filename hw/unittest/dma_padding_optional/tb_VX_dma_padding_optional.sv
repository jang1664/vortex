...
module tb_VX_dma_padding_optional import VX_gpu_pkg::*; #(
  ...
  task automatic run_transfer(
    ...
    begin
      ...
      cfg_regs_s = '0;
      cfg_regs_s[0] = 32'd1;
      cfg_regs_s[1] = 32'h0000_0800;
      cfg_regs_s[2] = 32'd0;
      cfg_regs_s[3] = 32'h0000_0100;
      cfg_regs_s[4] = 32'd0;
  ...
  initial begin
    ...
    if (NEGATIVE_PADDING) begin
      run_transfer(1'b0, DATA_SIZE, 1);
      $fatal(1, "nonzero padding guard did not fire");
    end
    ...
    $display("TEST PASSED: padding optional parity DATA_SIZE=%0d", DATA_SIZE);
    $finish;
  end
