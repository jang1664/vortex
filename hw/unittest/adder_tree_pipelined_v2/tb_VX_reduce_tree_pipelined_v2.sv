...
module tb_VX_reduce_tree_pipelined_v2;
    ...
    // No pipeline (combinational) - latency 0
    VX_reduce_tree_pipelined_v2 #(
        .IN_W(IN_W),
        .OUT_W(OUT_W),
        .N(N),
        .OP("+"),
        .PIPELINE_STAGES(0),  // 3'b000 - no pipeline
        .EB_SIZE(1),
        .EB_OUT_REG(1)
    ) dut_no_pipe (
        .clk(clk),
    ...
    VX_reduce_tree_pipelined_v2 #(
        ...
        .N(N),
        .OP("+"),
        .PIPELINE_STAGES(1),  // 3'b001 - pipeline at stage 0
        .EB_SIZE(1),
        .EB_OUT_REG(1)
    ) dut_stage0 (
        .clk(clk),
    ...
    VX_reduce_tree_pipelined_v2 #(
        ...
        .N(N),
        .OP("+"),
        .PIPELINE_STAGES(5),  // 3'b101 - pipeline at stage 0 and 2
        .EB_SIZE(1),
        .EB_OUT_REG(1)
    ) dut_stage0_2 (
        .clk(clk),
    ...
    VX_reduce_tree_pipelined_v2 #(
        ...
        .N(N),
        .OP("+"),
        .PIPELINE_STAGES(7),  // 3'b111 - pipeline at all stages
        .EB_SIZE(1),
        .EB_OUT_REG(1)
    ) dut_all_stages (
        .clk(clk),
