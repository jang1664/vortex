...
| --- | ---: | ---: | ---: | ---: |
| LUT | 34635 | 54869 | -20234 | -36.88% |
| FF | 12544 | 48320 | -35776 | -74.04% |
| RAMB36 | 56 | 0 | 56 | n/a |
...
are recorded for context but are not directly comparable. The direct comparison
with fixed OOC baseline 006 is in the parent experiment's `comparison.md`.
